...
# Entry Point
def mmmn_domain(user_input: np.ndarray, categoty: str, file_name: str) -> None:
    ...
    match file_type:
        case True:
            return process_img(user_input, CONFIG, categoty, file_name)
        case False:
            return process_video(user_input, CONFIG, categoty, file_name)
        case _:
...
def process_img(img: np.ndarray, CONFIG, categoty, file_name) -> dict:

    process_request(categoty, file_name)
