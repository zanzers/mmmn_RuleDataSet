...
def process_request(category: str, filename: str):
    

    # json Category 0 img_name check if the currnet are the same 
    # category if not create a new Set


    list_imgData(category)
